...
const addToken = (user_id, token, user_premium, payment_type, user_premium_expires_at) => {
   const QUERY = `
      UPDATE
         users
      SET
   ...
   return fetch(QUERY, user_id, token, user_premium, payment_type, user_premium_expires_at)
}
const deleteUser = (id) => {
   const QUERY = `
      DELETE FROM
